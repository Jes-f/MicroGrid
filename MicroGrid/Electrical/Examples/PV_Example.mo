...
equation
  ...
  connect(currentSensor1.currSignal, mppt1.i) annotation(Line(visible = true, origin = {41.376, -32.773}, points={{
          -14.5007,0.06041},{3.626,0.06041},{3.626,-0.0604097},{7.24894,
          -0.0604097}},                                                                                                                                                                  color = {255, 0, 0}));
  connect(voltageSensor1.voltSignal, mppt1.u) annotation(Line(visible = true, origin = {28.556, -43.814}, points={{-26.528,
  ...
  connect(V_dc.n, Boost.Output_n) annotation(Line(visible = true, origin = {-14.485, 71.154}, points={{2.3634,
          13.694},{-3.667,13.694},{-3.667,-7.817},{2.485,-7.817},{2.485,-11.754}},                                                                                                               color = {0, 0, 255}));
  ...
  connect(resistor1.p, currentSensor1.n) annotation(Line(visible = true, origin = {18.899, -11.202}, points={{4.031,
          20.394},{4.031,-5.798},{-4.03,-5.798},{-4.03,-8.798}},                                                                                                                  color = {0, 0, 255}));
  connect(voltageSensor1.voltSignal, boostControl1.V_measured) annotation(Line(visible = true, origin = {40.514, -13.092}, points={{-38.486,
          -32.9059},{-38.486,7.944},{38.486,7.944},{38.486,17.018}},                                                                                                                                           color = {255, 0, 0}));
  connect(capacitor1.p, resistor1.p) annotation(Line(visible = true, origin = {17.901, 5.577}, points={{
  ...
  connect(Boost.Input_n, capacitor1.n) annotation(Line(visible = true, origin = {-12.515, 18.293}, points={{0.515,
          12.307},{0.515,8.37},{-2.063,8.37},{-2.063,-14.524},{3.0948,-14.524}},                                                                                                                   color = {0, 0, 255}));
  connect(capacitor1.n, voltageSensor1.n) annotation(Line(visible = true, origin = {-12.191, -26.825}, points={{2.7708,
          30.594},{-2.387,30.594},{-2.387,-30.593},{2.005,-30.593}},                                                                                                                     color = {0, 0, 255}));
  connect(ground1.p, V_dc.n) annotation(Line(visible = true, origin = {-20.486, 84.305}, points={{-13.033,
          -0.543},{2.334,-0.543},{2.334,0.543},{8.3644,0.543}},                                                                                                         color = {0, 0, 255}));
  ...
  connect(Irradiation.y, PV1.Irr) annotation(Line(visible = true, origin = {14.332, -107.489}, points={{13.039,
          -2.511},{-6.52,-2.511},{-6.52,5.023}},                                                                                                            color = {1, 37, 163}));
